...
export default function ServiceCard({ number, title, description, href, buttonText }: ServiceCardProps) {
  return (
    <div className="p-8 bg-[#0E0E0E] border border-white/5 h-full flex flex-col hover:border-[#ddab22]/30 transition-all duration-300">
      ...
      <Link href={href}>
        <a className="inline-flex items-center gap-2 text-sm hover:text-[#ddab22] transition-colors">
